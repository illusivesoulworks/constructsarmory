...
public class ArmorDefinitionDataProvider extends AbstractToolDefinitionDataProvider {
  ...
  protected void addToolDefinitions() {
    defineArmor(ConstructsArmoryDefinitions.MATERIAL_ARMOR)
        ...
        .stat(ArmorSlotType.HELMET, ToolStats.ARMOR, 0)
        .stat(ArmorSlotType.CHESTPLATE, ToolStats.ARMOR, 0)
        .stat(ArmorSlotType.LEGGINGS, ToolStats.ARMOR, 0)
        .stat(ArmorSlotType.BOOTS, ToolStats.ARMOR, 0)
        .stat(ArmorSlotType.HELMET, ToolStats.ARMOR_TOUGHNESS, 0)
        .stat(ArmorSlotType.CHESTPLATE, ToolStats.ARMOR_TOUGHNESS, 0)
        .stat(ArmorSlotType.LEGGINGS, ToolStats.ARMOR_TOUGHNESS, 0)
        .stat(ArmorSlotType.BOOTS, ToolStats.ARMOR_TOUGHNESS, 0)
        .stat(ArmorSlotType.HELMET, ToolStats.KNOCKBACK_RESISTANCE, 0)
        .stat(ArmorSlotType.CHESTPLATE, ToolStats.KNOCKBACK_RESISTANCE, 0)
        .stat(ArmorSlotType.LEGGINGS, ToolStats.KNOCKBACK_RESISTANCE, 0)
        .stat(ArmorSlotType.BOOTS, ToolStats.KNOCKBACK_RESISTANCE, 0)
        .stat(ArmorSlotType.HELMET, ConstructsArmoryStats.MOVEMENT_SPEED, 0)
        .stat(ArmorSlotType.CHESTPLATE, ConstructsArmoryStats.MOVEMENT_SPEED, 0)
        .stat(ArmorSlotType.LEGGINGS, ConstructsArmoryStats.MOVEMENT_SPEED, 0)
        .stat(ArmorSlotType.BOOTS, ConstructsArmoryStats.MOVEMENT_SPEED, 0)
