...
public class ArmorMaterials {
    ...
    public static void registerArmorMaterialStats() {
        ...
        Material.UNKNOWN.addStats(new CoreMaterialStats(0, new float[]{0,0,0,0}));
